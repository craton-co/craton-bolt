...
fn upper_dict_pure(old_dict: &[String]) -> JavelinResult<(Vec<String>, Vec<i32>)> {
...
fn lower_dict_pure(old_dict: &[String]) -> JavelinResult<(Vec<String>, Vec<i32>)> {
...
fn lengths_table_pure(old_dict: &[String]) -> JavelinResult<Vec<i32>> {
...
pub fn upper(input: &DictionaryColumn) -> JavelinResult<DictionaryColumn> {
...
pub fn lower(input: &DictionaryColumn) -> JavelinResult<DictionaryColumn> {
...
pub fn length(input: &DictionaryColumn) -> JavelinResult<Int32Array> {
