...
Javelin v0.2 hand-emit PTX baseline — recovery floor for the
...
results, 2026-05-24" for the full table):
  ...
  proj       (passthrough)       Javelin   115.5  ms   (432.9 Melem/s)
  arith      (11-op chain)       Javelin   124.8  ms   (400.7 Melem/s)
  filtered   (filter + 4-op)     Javelin    41.8  ms   ( 1.196 Gelem/s)
...
annotation. Mark it **pre-release** (it is not a published Javelin
...
It is the floor — the version of Javelin we commit to being able
